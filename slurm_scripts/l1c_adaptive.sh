...
#SBATCH --job-name="l1c_adaptive"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=l1c_adaptive_%j.txt
#SBATCH --error=l1c_adaptive_%j.txt
#SBATCH --nodes=1
...
python3 -m scripts.optimize --seed $SLURM_ARRAY_TASK_ID --n 420 --len 10230 --p 6 --iters 1_000_000_000 --method AdaptiveKGreedyCodeOptimizer
