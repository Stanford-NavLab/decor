...
#SBATCH --job-name="l1ca_m=100"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=l1ca_m=100_%j.txt
#SBATCH --error=l1ca_m=100_%j.txt
#SBATCH --nodes=1
...
python3 -m scripts.optimize --seed $SLURM_ARRAY_TASK_ID --n 63 --len 1023 --p 6 --iters 1_000_000_000 --method TopKGreedyCodeOptimizer --args num_neighbors=100
