...
#SBATCH --job-name="gal_adaptive"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=gal_adaptive_%j.txt
#SBATCH --error=gal_adaptive_%j.txt
#SBATCH --nodes=1
...
python3 -m scripts.optimize --seed $SLURM_ARRAY_TASK_ID --n 100 --len 4092 --p 6 --iters 1_000_000_000 --method AdaptiveKGreedyCodeOptimizer
