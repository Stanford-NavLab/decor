...
#SBATCH --job-name="l1ca_psweep"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=l1ca_psweep_%j.txt
#SBATCH --error=l1ca_psweep_%j.txt
#SBATCH --nodes=1
...
python3 -m scripts.optimize --seed 0 --n 63 --len 1023 --p $SLURM_ARRAY_TASK_ID --iters 1_000_000_000 --method AdaptiveKGreedyCodeOptimizer
