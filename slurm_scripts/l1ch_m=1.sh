...
#SBATCH --job-name="l1ch_m=1"
#SBATCH --mail-user=yalan@stanford.edu
#SBATCH --mail-type=END
#SBATCH --output=l1ch_m=1_%j.txt
#SBATCH --error=l1ch_m=1_%j.txt
#SBATCH --nodes=1
...
python3 -m scripts.optimize --seed $SLURM_ARRAY_TASK_ID --n 210 --len 10230 --p 6 --iters 1_000_000_000 --method TopKGreedyCodeOptimizer --args num_neighbors=1
